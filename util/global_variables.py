...
INTRADAY_M5_TARGET_MULTIPLIER = 4.25
INTRADAY_M15_TARGET_MULTIPLIER = 4.25
INTRADAY_LEVERAGE_MULTIPLIER = 4.75  # Always maintain a minimum cash buffer of 5% undeployed at all times.
INTRADAY_M5_ATR_RISK_MULTIPLIER = 0.4
INTRADAY_M15_ATR_RISK_MULTIPLIER = 0.25
...
INTRADAY_HISTORICAL_DATA_CACHE_DAYS = 1  # minimum for correct indicator computation
...
TRADING_CAPITAL = 400000
MAX_RISK_PER_TRADE_PERCENT = 0.025
MIN_ADV_PARTICIPATION_RATE = 0.04
MAX_BREAKOUT_PARTICIPATION = 0.05
NSE_MAX_SPREAD_ATR_RATIO = 0.10
MAX_OPENING_GAP_PCT = 3.0
MIN_OPENING_GAP_PCT = 0.0
